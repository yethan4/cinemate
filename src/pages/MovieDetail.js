...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=437fbd5832909bdb0e566412251cf8f3
      `);
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
          ...
          { movie.genres ? ( 
            ...
            <p className="my-4">
              ...
              <a className="hover:underline cursor:pointer" href={`https://www.imdb.com/title/${movie.imdb_id}`} target="_blank" rel="noreferrer">{movie.imdb_id}</a>
            </p>
